...
function PostgresJSONAdvancedLoopQueryStrategy() {
...
PostgresJSONAdvancedLoopQueryStrategy.prototype.compose = function(serializedCriteria) {
    var query = "SELECT * FROM data d ";
    var whereClause = "WHERE type = $1";
    var parameters = [ serializedCriteria.dataType ];
...
module.exports = PostgresJSONAdvancedLoopQueryStrategy;
